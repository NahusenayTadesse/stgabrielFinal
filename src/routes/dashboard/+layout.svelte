...
<Sidebar.Provider>
	...
	<div class="flex w-full flex-col gap-4 p-3">
		<div
			class="absolute top-2 left-2 z-100 flex w-[95%]
			flex-row justify-between rounded-lg p-2 pr-4
		 align-middle shadow-lg backdrop-blur-md lg:sticky lg:w-auto lg:pr-0"
		>
