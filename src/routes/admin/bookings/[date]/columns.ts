...
import DataTableSort from '$lib/components/Table/data-table-sort.svelte';
 ...
 export const columns = [
    ...
    { accessorKey: 'customerName',
      ...
      return renderComponent(DataTableLinks, { id: row.original.extraSettings, name: row.original.customerName, link: '/admin/bookings/single'});
    }},
    ...
    { accessorKey: 'bookedAt', header: ({ column }) =>
      ...
      return renderComponent(DataTableActions, { id: row.original.extraSettings, phone: row.original.phone, 
       customerName: row.original.customerName, date: row.original.date});
    } }
  ];